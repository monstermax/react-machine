...
```tsx
<Cpu type="custom">    // React CPU (par défaut)
...
1. **Maintenant** : Continue sur ton CPU custom (Phase 1-5 de la ROADMAP)
2. **Dans 1 mois** : Refactoring pour architecture multi-CPU (Étape 1-2)
3. **Dans 2 mois** : Implémentation Z80 progressive (Étape 3-4)
4. **8086** : Oublie pour l'instant, c'est un autre monde

Le Z80 est le choix naturel, l'8086 serait un projet complètement séparé.
