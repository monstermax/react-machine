...
export const programs = {
    ...
    hello_world: {
        ...
        code: new Map([
            ...
            // (space)
            [0x1C, Opcode.R_LOAD_A],
            [0x1D, 0x20], // ' '
            [0x1E, Opcode.M_STORE_A],
            [0x1F, 0x70], [0x20, 0xFF],
            ...
            // o
            [0x26, Opcode.R_LOAD_A],
            [0x27, 0x6F], // 'o'
            [0x28, Opcode.M_STORE_A],
            [0x29, 0x70], [0x2A, 0xFF],

            // r
            [0x2B, Opcode.R_LOAD_A],
            [0x2C, 0x72], // 'r'
            [0x2D, Opcode.M_STORE_A],
            [0x2E, 0x70], [0x2F, 0xFF],

            // l
            [0x30, Opcode.R_LOAD_A],
            [0x31, 0x6C], // 'l'
            [0x32, Opcode.M_STORE_A],
            [0x33, 0x70], [0x34, 0xFF],

            // d
            [0x35, Opcode.R_LOAD_A],
            [0x36, 0x64], // 'd'
            [0x37, Opcode.M_STORE_A],
            [0x38, 0x70], [0x39, 0xFF],

            // !
            [0x3A, Opcode.R_LOAD_A],
            [0x3B, 0x21], // '!'
            [0x3C, Opcode.M_STORE_A],
            [0x3D, 0x70], [0x3E, 0xFF],

            // Newline
            [0x3F, Opcode.R_LOAD_A],
            [0x40, 0x0A], // '\n'
            [0x41, Opcode.M_STORE_A],
            [0x42, 0x70], [0x43, 0xFF],
