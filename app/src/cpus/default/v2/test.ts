...
import { compile, formatBytecode } from './index';
...
const result1 = compile(test1, CUSTOM_CPU);
...
const result2 = compile(test2, CUSTOM_CPU);
...
const result3 = compile(test3, CUSTOM_CPU);
