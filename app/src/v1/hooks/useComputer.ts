...
import { useCpu, type CpuHook } from "@/v1/hooks/useCpu";
import { useRom, type RomHook } from "@/v1/hooks/useRom";
...
import { compileCode, compileFile, loadSourceCodeFromFile } from "@/v1/cpus/default/compiler_v1/asm_compiler";
