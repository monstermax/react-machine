...
import { compileCode, getBytecodeArray, loadSourceCodeFromFile, setCompilationAsmBaseUrl } from '@/v2/lib/compilation';
...
async function main() {
    ...
    setCompilationAsmBaseUrl('http://localhost:5173');
...
hlt
    ...
    const code = getBytecodeArray(compiled)
