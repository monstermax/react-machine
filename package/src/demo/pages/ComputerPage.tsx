...
import { Computer, Cpu, Memory, Motherboard, Rom, Ram, ExternalDevices, InternalDevices, Clock, PowerSupply } from '@/core/components' // 'react-machine-package/core-components'
import { Dma, Interrupt, Timer, CpuInstructions, MemoryMap, IDE } from '@/core/components' // 'react-machine-package/core-components'
import { StorageDisk, LedsDisplay, Buzzer, PixelDisplay, Rng, Rtc, LcdDisplay, Console, SevenSegmentDisplay, Keyboard } from '@/devices/components' // 'react-machine-package/devices-components'
import { MEMORY_MAP, loadSourceCodeFromFile, compilerV2 } from '@/index' // 'react-machine-package';
import type { u16, u8 } from '@/types' // 'react-machine-package/types';
            ...
            <div className="pb-1">
                <Computer>
                    <Motherboard>
                        ...
                        <InternalDevices>
                            <Clock ioPort={0x12} frequency={1} open />
