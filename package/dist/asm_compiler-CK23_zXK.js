...
function l(e, s = 0) {
  const a = e.toString(16).toUpperCase();
  let n = a.length % 2 === 0 ? a : `0${a}`;
...
function W(e) {
  return Object.fromEntries(
    Object.entries(e).map(([s, a]) => [s, a])
  );
}
const ae = (e) => e >= E.ROM_START && e <= E.ROM_END, ie = (e) => e >= E.OS_START && e <= E.STACK_END, ue = (e) => e >= E.IO_START && e <= E.IO_END, Ae = (e) => w(e - E.IO_START);
async function G(e) {
  e.endsWith(".ts");
...
}, p = (e) => d.includes(e) ? 2 : y.includes(e) ? 3 : 1, Me = (e) => {
  const a = (Array.isArray(e) ? e : Array.from(e.entries())).sort(([t], [r]) => t - r), n = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Set();
  for (const [t, r] of a) {
    if (_.has(t)) {
      n.set(t, !1);
      continue;
    }
    Object.values(R).includes(r) ? (n.set(t, !0), d.includes(r) && _.add(t + 1), y.includes(r) && (_.add(t + 1), _.add(t + 2))) : n.set(t, !1);
  }
  return n;
};
async function k() {
...
function $(e) {
  ...
  ]), a = new Map(s), n = e.map((t) => [t[0], t[2]]), _ = e.map((t) => [t[0], t[3]]);
  return { code: a, comments: n, labels: _ };
}
async function x(e, s = 0, a = 0, n = [], _ = /* @__PURE__ */ new Map()) {
  const t = await G(e);
  return await F(t, s, a, n, _);
}
async function F(e, s = 0, a = 0, n = [], _ = /* @__PURE__ */ new Map()) {
  const t = Q(e);
  return await z(t, s, a, n, _);
}
function Q(e) {
  var _, t;
  const s = e.split(`
`).filter((r) => r.trim() && !r.trim().startsWith(";")), a = [];
  for (const r of s) {
    const A = r.split(";"), M = ((_ = A[0]) == null ? void 0 : _.trim()) || "", c = ((t = A.slice(1)) == null ? void 0 : t.join(";").trim()) || "", D = j(M), m = {
      opcode: D[0] || -1,
      params: D.slice(1),
      comment: c
    };
...
function j(e) {
  if (!e.includes('"'))
    return e.split(" ");
  const s = e.split('"'), [a, n, _] = s, t = "__string_replacement__";
  return [a, t, _].join("").split(" ").map((c) => c.replace(t, `"${n}"`));
}
function X(e, s, a = !0, n = !0) {
  const _ = [];
...
async function z(e, s, a, n = [], _ = /* @__PURE__ */ new Map()) {
  const t = [];
  let r = a, A = [];
  const M = [], c = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), m = /* @__PURE__ */ new Map();
  for (const P of e) {
    ...
    if (S.startsWith(".")) {
      if (S === ".string" || S === ".ascii") {
        ...
        t.push(...g), D.set(u, H(s + r)), r = H(r + g.length);
      }
      A = [];
      continue;
    }
    ...
    if (i !== void 0 && (i.startsWith("<") || i.startsWith(">")) && (f = i.startsWith("<") ? "low" : "high", i = i.slice(1)), i.startsWith("$")) {
      if (i = i.slice(1), K) {
        const C = i;
        t.push([r, "<$" + C, "", []]), r++, t.push([r, ">$" + C, "", []]), r++;
        continue;
      }
      const u = c.get(i);
      if (u !== void 0) {
        u.bytes === 8 ? (t.push([r, l(w(Number(u.value))), "", []]), r++) : u.bytes === 16 && ((f === null || f === "low") && (t.push([r, l(L(Number(u.value))), "", []]), r++), (f === null || f === "high") && (t.push([r, l(V(Number(u.value))), "", []]), r++));
        continue;
      }
      const I = D.get(i);
      if (I !== void 0) {
    ...
    for (let u = 1; u <= b; u++) {
      const I = u === 1 ? L(Number(i)) : V(Number(i)), C = [
        r,
        l(I),
        "",
        []
  ...
  for (const P of M) {
    const S = [...n, ...M, ...N], T = new Map([..._, ...m, ...h]), O = await x(P, s, H(r), S, T), i = O.code.at(-1);
  ...
  return { code: t.map((P) => {
    ...
    if (o.startsWith("<") || o.startsWith(">"))
      if (o.startsWith("<") ? (o = o.slice(1), B = "low") : o.startsWith(">") && (o = o.slice(1), B = "high"), o.startsWith("$")) {
        o = o.slice(1);
        const K = o, f = t.find((C) => C[3] && C[3].includes(K));
        if (!f)
...
function q(e) {
  ...
  for (let a = 0; a < s.length; a++) {
    let n = s[a], _ = null;
    if (n.startsWith("<") ? (_ = "low", n = n.slice(1)) : n.startsWith(">") && (_ = "high", n = n.slice(1)), n = n.replace("@", "MEMORY_MAP."), n !== "" && n.includes("MEMORY_MAP.")) {
      ...
      try {
        ...
        n = l(M), _ === "low" && (n = L(Number(n)).toString()), _ === "high" && (n = V(Number(n)).toString()), s[a] = n;
      } catch {
        debugger;
...
function ee(e) {
  const s = [], a = E.PROGRAM_START;
  for (let n = 0; n < e.length; n++) {
    const _ = e[n], t = _[0] + a;
    if (_[1].split(".")[0] !== "Opcode")
      throw new Error(`Invalid instruction at line ${t}`);
    const A = _[1].replace("Opcode.", ""), M = R[A], c = p(M) - 1;
    let D = null;
    if (c) {
      D = 0;
      for (let N = 1; N <= c; N++) {
